...
/home/fkunzwei/data1/envs/bkg_pipe/bin/python -m luigi --workers 32 --module gbm_bkg_pipe RangeDailyBase --of CreateReportDate --days-back=5 --stop $(date +'%Y-%m-%d') --reverse
