        ...
        for trigger in self._triggers:
            ...
            if self._show_counts:
                ...
                for e in range(8):
                    ...
                    ax[i].axvline(x=trigger["trigger_time"], ymin=-1.2, ymax=1, c="green", linewidth=1, zorder=0, clip_on=False, label='peak counts')
            ...
            if self._show_all_echans:
                ...
                ax[i].axvline(x=trigger["trigger_time"], ymin=0, ymax=1.2, c="green", linewidth=1, zorder=0 ,clip_on=False)
            ...
            ax[0].set_title(f"Trigger {trigger['trigger_name']} | Det {trigger['most_significant_detector']}")
            ...
            savepath = os.path.join(outdir, f"{trigger['trigger_name']}.png")
