...
from gbm_bkg_pipe.utils.stats.significance_from_pvalue import significance_from_pvalue
...
def z_bi_vectorized(n, b, alpha):
    ...
    if alpha_.shape[0] == 1:
        ...
        assert (
            alpha_.shape[0] == n_.shape[0]
        ), "Alpha must be either a scalar or an array of the same length of n"
